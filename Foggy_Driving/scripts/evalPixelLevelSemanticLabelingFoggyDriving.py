...
args.exportFile         = os.path.join(os.environ['EVALUATION_RESULTS_PATH'], os.environ['EVALUATION_RESULTS_FILE'] )
args.groundTruthSearch  = os.path.join( args.cityscapesPath , "gt*" , "test*" , "*", "*_gt*_labelIds.png" )
